...
\logo{\includegraphics[width=0.75cm]{imgs/uern}}
...
\begin{frame}
    ...
    \exemp
    {
        ...
        Nyquist \implica 6.2 K amostras/segundo \implica 6200
        amostras/segundo
        ...
        Cada amostra = 8 bits \implica 8000 * 8 bits = 64 Kbps (padrão definido
